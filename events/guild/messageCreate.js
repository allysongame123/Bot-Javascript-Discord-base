...
module.exports = async (client, message) => {
    ...
    if(!cmd || cmd.length == 0){
        if(mPrefix.includes(client.user.id)){
            message.reply({embeds: [new Discord.MessageEmbed().setColor(ee.rainbow).setFooter(ee.footertext, ee.footericon).setTitle(`🎄**My Prefix here, is __\`${prefix}\`__**`)
            .setImage(`https://api.creavite.co/out/985042d6-7e32-4a9a-96f7-18af405979b5_standard.gif`)]})
